 ...
 * Para el vendedor Constutucional
 */
public class Valores1Strategy implements PrestamoStrategy {
    @Override
    public Prestamo pedirPrestamo(String tipo) {
        Prestamo prestamo =new Prestamo();
        Empresa empresa = new Empresa();

        prestamo= empresa.obtenerPrestamo("Prestamo de hasta $300,000 pesos", tipo);
        ...
        if (prestamo.getDescripcion()== null){
            prestamo = empresa.obtenerPrestamo("Prestamo de hasta $70,000", tipo);
